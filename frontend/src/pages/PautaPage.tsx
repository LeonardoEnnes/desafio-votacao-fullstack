...
import {
    ArrowLeft, PlayCircle, CheckCircle2, XCircle, BarChart3, Clock,
} from 'lucide-react';
...
export function PautaPage() {
    ...
    const {
        ...
        feedback, votando, abrindo, abrirSessao, votar, recarregar,
    } = usePautaDetalhe(id);
        ...
        <div className="space-y-6 max-w-4xl mx-auto animate-in fade-in duration-300">
            ...
            <Card className="border-slate-200 shadow-sm">
                <CardHeader>
                    <Badge
                        variant="outline"
                        className="w-fit border-emerald-200 text-emerald-700 bg-emerald-50 font-mono mb-2"
                    >
                        ID: {pauta.id}
                    </Badge>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-emerald-50/50 rounded-lg border border-emerald-100">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <strong className="text-sm text-slate-800">
                                    {sessaoAberta
                                        ? 'Aberta para recebimento de votos'
                        ...
                        {pauta.sessao?.dataEncerramento && (
                            <div className="text-xs text-slate-600">
                                Encerramento:{' '}
                                <strong>{formatarData(pauta.sessao.dataEncerramento)}</strong>
                            </div>
                        )}
                    </div>
